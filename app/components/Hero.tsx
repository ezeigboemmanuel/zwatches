...
const Hero = () => {
  return (
    <div className="min-h-[90vh] flex justify-center items-center bg-[#212529] px-4 md:px-12 text-white">
      <div className="max-w-2xl">
        <h1 className="text-7xl leading-tight font-semibold">Timeless Elegance on Your Wrist</h1>
        <p className="text-[#E9ECEF] mt-4">
          Discover our curated collection of premium watches, crafted for those
          who appreciate sophistication and precision.
        </p>
        <button className="mt-8 bg-[#495057] hover:bg-[#343A40] text-white px-3 py-2 rounded-md">Shop the Collection</button>
      </div>
      <div>
